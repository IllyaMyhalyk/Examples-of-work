...
addFieldButton.addEventListener('click', (event) => {
  ...
  <td>
    <input class="form__textarea" type="text" name="item-${counter}" maxlength="100" placeholder="назва деталі" required></input> 
  </td>
  <td>
    <input class="form__number" name="quantity-${counter}" type="text" maxlength="2" placeholder="кількість деталей" value="1" required>
  </td>`;
